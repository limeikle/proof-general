...
package ed.inf.proofgeneral.prover.template.wizards;
 ...
 *
 */
public class NewTemplateProofScriptWizard extends NewProofScriptWizard {
	/**
	 * Adding the page to the wizard.
	 */
	@Override
    public void addPages() {
		page = new NewProofScriptWizardPage(selection, "template", "NewTemplate", "Theory");
		addPage(page);
	}
