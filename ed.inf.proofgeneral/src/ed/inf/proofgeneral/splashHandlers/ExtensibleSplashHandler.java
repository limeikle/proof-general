...
package ed.inf.proofgeneral.splashHandlers;
...
public class ExtensibleSplashHandler extends AbstractSplashHandler {
	...
	private final static String F_SPLASH_EXTENSION_ID = "ed.inf.proofgeneral.splashExtension"; //NON-NLS-1
	...
	/**
	 * @return splash screen width minus two graphic border bevel widths
	 */
