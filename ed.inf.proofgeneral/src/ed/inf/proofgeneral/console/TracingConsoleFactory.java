...
/**
 * Factory for tracing consoles.  Returns unique console for a given session manager.
...
public class TracingConsoleFactory implements IConsoleFactory {
	...
	public static void showConsole() {
		TracingConsole console = TracingConsole.getCurrentConsole();
		if (console != null) {
