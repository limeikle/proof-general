/*
 *  $RCSfile: EclipseActionNew.java,v $
 *
...
public class EclipseActionNew extends TextEditorAction implements IWorkbenchWindowActionDelegate {
	...
	public EclipseActionNew(ITextEditor editor) {
