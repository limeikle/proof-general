 ...
 */
public class ActivateAction extends PGRetargetableAction {
	...
	public ActivateAction(ProofScriptEditor editor) {
...
//			updateStatus(STATUS_FAILED);
    ...
    private void activateAction() throws ScriptingException {
		...
		final SessionManager sm = editor.getSessionManager();
...
// FIXME: cleanup junk here.
	...
	public boolean closeDownScript(ProofScriptDocument script, SessionManager sm, boolean canCancel) {
		...
		try {
			...
			new UndoAllAction(script, getSessionManagerForRunningAction()).run();
			return true;
