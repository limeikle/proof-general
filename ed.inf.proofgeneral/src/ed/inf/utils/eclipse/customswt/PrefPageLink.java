 ...
 ******************************************************************************/
/*
 *  $RCSfile: PrefPageLink.java,v $
 *
 *  Created 2004
 *  Taken from Eclipse API (see copyright notice above)
 */
 ...
 * </p>
 */
public class PrefPageLink extends FieldEditor {
	 ...
	 * @since 2.0
	 */
	public PrefPageLink(String name, String labelText, int width, int strategy,
			Composite parent) {
		init(name, labelText);
		widthInChars = width;
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public PrefPageLink(String name, String labelText, int width,
			Composite parent) {
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public PrefPageLink(String name, String labelText, Composite parent) {
	...
	public Label getTextControl(Composite parent) {
		if (textField == null) {
			textField = new Label(parent, SWT.NONE);
			textField.setFont(parent.getFont());
			// TODO textField.add Mouse Up Listener new ... to make link
	 ...
	 *
	 * @param value the new value, or <code>null</code> meaning the empty
	 *            string
	 */
	 ...
	 *
	 * @param limit the limit on the number of character in the text input
	 *            field, or <code>UNLIMITED</code> for no limit
	 */
	/*
	 * public void setTextLimit(int limit) { textLimit = limit; if (textField !=
	 * null) textField.setTextLimit(limit); }
	 */
	 ...
	 * </p>
	 *
	 * @param value either <code>VALIDATE_ON_KEY_STROKE</code> to perform on
	 *            the fly checking (the default), or
	 *            <code>VALIDATE_ON_FOCUS_LOST</code> to perform validation
	 *            only after the text has been typed in
	 */
	public void setValidateStrategy(int value) {
		assert (value == VALIDATE_ON_FOCUS_LOST
				|| value == VALIDATE_ON_KEY_STROKE) : "Bad validate strategy";
		validateStrategy = value;
	}

	/**
	 * @see #setValidateStrategy(int)
	 * @return the validate strategy; one of <code>VALIDATE_ON_KEY_STROKE</code>
	 * 			or <code>VALIDATE_ON_FOCUS_LOST</code>.
	 */
