 ...
 ******************************************************************************/
/*
 *  $RCSfile: TextFieldEditor.java,v $
 *
 *  Created 2003 by IBM Corporation
 *  Taken from Eclipse internal StringFieldEditor (Eclipse v3.0, M7).
...
/**
 * A field editor for a multi-line string type preference. Copied shamelessly
 * from StringFieldEditor (Eclipse v3.0, M7)
 */
public class TextFieldEditor extends FieldEditor {
	...
	public Text getTextControl(Composite parent) {
		if (textField == null) {
			textField = new Text(parent, SWT.MULTI | SWT.H_SCROLL
			...
			case VALIDATE_ON_FOCUS_LOST:
				...
				break;
			default:
				assert false : "Unknown validate strategy";
				break;
			}
	...
	public void setValidateStrategy(int value) {
		assert value == VALIDATE_ON_FOCUS_LOST
		    || value == VALIDATE_ON_KEY_STROKE : "Bad validate strategy code";
