...
begin
(* This theory contains 1000 copies of a trivial theorem, for testing.
   I created it in Emacs!  Of course.  Maybe one day Eclipse will 
   support the very useful commands 
   M-1000 C-y
   M-x replace-regexp foo → foo\,(line-number-at-pos (point))
*)

(* Status 09.01.07: takes a couple of minutes to process this file, 
   and many minutes to undo it!!!  Undo is badly broken.
*)
(* set global_timing *)
